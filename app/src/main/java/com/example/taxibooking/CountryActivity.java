...
public class CountryActivity extends AppCompatActivity {
    ...
    String[] arrayone =  {"Saudi Arabia", "Australia", "Canada", "England", "Japan", "India"};
    Integer [] arraytwo = {R.drawable.sa, R.drawable.aus, R.drawable.can, R.drawable.eng, R.drawable.jap, R.drawable.ind};
